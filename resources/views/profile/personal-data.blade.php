...
<div class="row">
    ...
    <form action="{{ route('user.update') }}" method="post" class="form-content mb-4 col-xs-12 col-md-12 col-lg-9">
        ...
        <div class="form-group row">
            ...
            <div class="form-floating mb-3 col-sm-12 col-md-6 col-lg-6">
                <input name="curator_job" type="text" class="form-control @error('curator_job') is-invalid @enderror"
...
<div class="row mt-4">
    <form action="{{ route('user.change_password') }}" method="post" class="form-content col-xs-12 col-md-12 col-lg-12">
        @csrf
        @method('put')
