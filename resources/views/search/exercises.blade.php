...
@section('content')
    ...
    <div class="container search-container">
        <p class="h1-content">Поиск по сайту</p>
                <form action="{{route('exercises.search')}}" method="get" class="d-flex justify-content-between form-floating col-sm-12 col-md-10 col-lg-12">
            ...
            <div class="row">
                @if($exercises)
                    @forelse($exercises as $exercise)
                            <a href="{{route('blocks.exercises.show',[$exercise->block, $exercise->id])}}" class="col-sm-12 col-md-5 search-item" style="text-decoration: none">
                                <span class="text-muted">Упражнение</span> <p class="h1">{{$exercise->title}} </p>
