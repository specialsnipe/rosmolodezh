                    ...
                    <div class="col-sm-6 ">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a
                                    href="{{ route('admin.tracks.index') }}">Направления</a>
                            </li>
                    ...
                    <div class="card-header">
                        <div class=" row align-items-center">
                            ...
                            <div class="col-sm-12 col-lg-4 d-flex justify-content-md-end">
                                <a class="btn btn-info mr-2" href="{{ route('admin.tracks.edit', $track->id) }}">Изменить
                                    <i
                                        class="fa fa-pen"></i></a>
                            ...
                            <table class="table table-hover table-head-fixed text-nowrap">
                                ...
                                @forelse($block->exercises as $exercise)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.blocks.exercises.show', [$block->id, $exercise->id])}}">{{ $exercise->title }}
                                                <span class="text-muted">(id: {{ $exercise->id }})</span></a></td>
                                        ...
                                        <td>
                                            <table class="table-head-fixed text-nowrap">
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="{{route('admin.exercises.answers.index', $exercise->id)}}">Сдано
                                                            работ:</a></td>
                                                    <td>{{ $exercise->answers_added_count }}
                                                        /{{ $track->users_count }}</td>
                                                </tr>
                                                <tr>
                                                    <td>Оценено:</td>
                                                    <td>
                                                        {{$exercise->mark_count }}/{{ $track->users_count }}</td>
                                                </tr>
                                                <tr>
                                                    <td>Успеваемость:</td>
                                                ...
                                                <tr>
                                                    <td>Средний балл:</td>
                                                    <td><span
                                                            class="status_block status_success">{{$exercise->average_score}}</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
