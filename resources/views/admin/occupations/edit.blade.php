    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Изменение занятости: "{{$occupation->name}}"</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('admin.main.index')}}">Главная</a></li>
                            <li class="breadcrumb-item"><a href="{{route('admin.handbook.index')}}">Справочник</a></li>
                            <li class="breadcrumb-item"><a href="{{route('admin.handbook.occupations.index')}}">Занятость</a></li>
        ...
        <div class="col-4">
            <form action="{{route('admin.handbook.occupations.update', $occupation->id)}}" method="post">
                @csrf
                @method('patch')
