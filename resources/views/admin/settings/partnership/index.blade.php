...
@section('content')
    <div class="content-wrapper" style="padding-top: 1rem">
        ...
        <div class="row d-flex justify-content-between mr-3 ml-3">
            <div class="col-sm-6">
                <h1 class="">Управление страницей Партнёрство</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right ">
                    <li class="breadcrumb-item"><a href="{{route('admin.main.index')}}">Главная</a></li>
                    <li class="breadcrumb-item"><a href="{{route('admin.settings.index')}}">Настройки</a></li>
                    <li class="breadcrumb-item">Управление страницей Партнёрство</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
        <div class="row m-3">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.settings.partnership.edit', $partnership->id) }}" class="btn btn-success">Изменить</a>
                    </div>
                    <div class="card-body">
                        <div class="row">
